MUST_Fungi_Roditis_2020.2021
MUST_Fungi_Sideritis_2020.2021
...
cairo_pdf("Fungi Roditis Antioxidant.pdf", height = 7, width = 7)
...
par(adj = 1)
title(sub = "Fungi Roditis Antioxidant")
par(adj = .5)
...
# start the graphics device
cairo_pdf("Fungi Sideritis Antioxidant.pdf", height = 7, width = 7)
...
par(adj = 1)
title(sub = "Fungi Sideritis Antioxidant")
par(adj = .5)
# add the env parameter arrows (in the rgb colouring mode we have the red, green and blue values from 0 to 255 and also the alpha value or transparency which also ranges between 0 and 255)
